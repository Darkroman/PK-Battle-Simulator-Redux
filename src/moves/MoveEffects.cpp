...
void IMoveEffects::InflictNVStatus(Status status, int chance, MoveEffectsDependencies& deps)
{
	...
	if ((ctx.defendingPokemon->HasSubstitute() && !deps.context.currentMove->mp_move->CanBypassSubstitute()) || ctx.defendingPokemon->GetCurrentHP() <= 0 || ctx.defendingPokemon->GetStatus() != Status::Normal || ctx.flags.currentEffectiveness == BattleStateFlags::Effectiveness::No)
	{
		return;
	}
...
void NormalHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void IncreasedCritical::DoMove(MoveEffectsDependencies& deps) {
	auto& ctx = deps.context;
	...
	deps.statusManager.CheckFaintCondition(
		ctx.attackingPlayer, ctx.defendingPlayer, ctx.attackingPokemon, ctx.defendingPokemon);

	ctx.attackingPokemon->SetLastUsedMove(ctx.currentMove);
}

void MultiAttack::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void BurnHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		InflictNVStatus(Status::Burned, 10, deps);
...
void FreezeHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		InflictNVStatus(Status::Frozen, 10, deps);
...
void ParalyzeHit10::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		InflictNVStatus(Status::Paralyzed, 10, deps);
...
void OHKO::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void RazorWind::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void AttackUp2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Gust::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void MakeEnemySwitch::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		{
			// Update player two's current Pokémon similarly
...
void Fly::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Bound::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Stomp::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DoubleHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void JumpKick::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void FlinchHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void AccuracyDown::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	else if (ctx.flags.hit && !ctx.defendingPokemon->HasSubstitute())
	{
		if (ctx.defendingPokemon->GetAccuracyStage() > -6)
		{
			...
			deps.resultsUI.DisplayAccuracyLoweredTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
		}
		else
		{
...
void BodySlam::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void RecoilQuarter::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Thrash::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	{
		deps.statusManager.ThrashConfuse();
	}
	...
	{
		deps.statusManager.ThrashStop();
		deps.statusManager.ThrashReset();
	}
...
void RecoilThird::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DefenseDown::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void PoisonHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		deps.resultsUI.DisplayEffectivenessTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
		deps.resultsUI.DisplaySubstituteDamageTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
		InflictNVStatus(Status::Poisoned, 30, deps);
		deps.statusManager.CheckSubstituteCondition(ctx.defendingPlayer, ctx.defendingPokemon);
	}
	else
	{
...
void Twineedle::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		while (turnCount != 0 && ctx.defendingPokemon->GetCurrentHP() > 0)
		{
			...
			deps.resultsUI.DisplayEffectivenessTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
			deps.resultsUI.DisplaySubstituteDamageTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
			InflictNVStatus(Status::Poisoned, 20, deps);
			deps.statusManager.CheckSubstituteCondition(ctx.defendingPlayer, ctx.defendingPokemon);
...
void AttackDown::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	else if (ctx.flags.hit && (!ctx.defendingPokemon->HasSubstitute() || ctx.currentMove->mp_move->CanBypassSubstitute()))
	{
...
void BypassSubSleep::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Confuse::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SonicBoom::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Disable::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SpecialDefenseDownHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Mist::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void ConfuseHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SpeedDownHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void AttackDownHit::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void RechargeAttack::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void LowKick::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Counter::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SeismicToss::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Leech::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void LeechSeed::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Growth::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SolarBeam::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void PoisonPowder::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void StunSpore::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SleepPowder::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SpeedDown2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DragonRage::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Paralyze::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	bool isImmune = (ctx.defendingPokemon->GetTypeOneEnum() == PokemonType::Electric
...
void ParalyzeHit30::DoMove(MoveEffectsDependencies& deps)
{
    auto& ctx = deps.context;
...
void Earthquake::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Dig::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Toxic::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SleepMove::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void AttackUp::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SpeedUp2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Rage::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Teleport::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void NightShade::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Mimic::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DefenseDown2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void EvasionUp::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void HealHalfHP::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DefenseUp::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Minimize::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DefenseUp2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void LightScreen::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Haze::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Reflect::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void FocusEnergy::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Bide::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Metronome::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	{
		std::unique_ptr<IMoveEffects> moveEffect = MoveEffectsFactory::Call(selectedMove->GetMoveEffectEnum());
...
void MirrorMove::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Explosion::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void PoisonHit40::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
	...
	if (ctx.flags.hit)
	{
		...
		deps.resultsUI.DisplayEffectivenessTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
		deps.resultsUI.DisplaySubstituteDamageTextDialog(ctx.defendingPlayer, ctx.defendingPokemon);
		InflictNVStatus(Status::Poisoned, 40, deps);
		deps.statusManager.CheckSubstituteCondition(ctx.defendingPlayer, ctx.defendingPokemon);
	}
	else
	{
...
void FlinchHit10::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void FlinchHit20::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Swift::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SkullBash::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SpecialDefenseUp2::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void DreamEater::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void PoisonGas::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SkyAttack::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Transform::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void ConfuseHit20::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Psywave::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Splash::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Rest::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Conversion::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void TriAttack::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void SuperFang::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Substitute::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
...
void Struggle::DoMove(MoveEffectsDependencies& deps)
{
	auto& ctx = deps.context;
